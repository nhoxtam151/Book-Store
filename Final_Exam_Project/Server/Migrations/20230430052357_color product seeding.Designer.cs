...
namespace Final_Exam_Project.Server.Migrations
{
    ...
    [Migration("20230430052357_color product seeding")]
    partial class colorproductseeding
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Final_Exam_Project.Shared.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            DateCreated = new DateTime(2023, 4, 30, 12, 23, 56, 946, DateTimeKind.Local).AddTicks(9082),
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            DateCreated = new DateTime(2023, 4, 30, 12, 23, 56, 946, DateTimeKind.Local).AddTicks(9099),
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 1,
                            DateCreated = new DateTime(2023, 4, 30, 12, 23, 56, 946, DateTimeKind.Local).AddTicks(9100),
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 2,
                            DateCreated = new DateTime(2023, 4, 30, 12, 23, 56, 946, DateTimeKind.Local).AddTicks(9101),
                        ...
                        new
                        {
                            Id = 5,
                            CategoryId = 2,
                            DateCreated = new DateTime(2023, 4, 30, 12, 23, 56, 946, DateTimeKind.Local).AddTicks(9102),
                        ...
                        new
                        {
                            Id = 6,
                            CategoryId = 2,
                            DateCreated = new DateTime(2023, 4, 30, 12, 23, 56, 946, DateTimeKind.Local).AddTicks(9108),
                        ...
                        new
                        {
                            Id = 8,
                            CategoryId = 3,
                            DateCreated = new DateTime(2023, 4, 30, 12, 23, 56, 946, DateTimeKind.Local).AddTicks(9109),
                        ...
                        new
                        {
                            Id = 9,
                            CategoryId = 3,
                            DateCreated = new DateTime(2023, 4, 30, 12, 23, 56, 946, DateTimeKind.Local).AddTicks(9111),
            ...
            modelBuilder.Entity("ColorProduct", b =>
                {
                    b.HasOne("Final_Exam_Project.Shared.Color", null)
                        .WithMany()
                        .HasForeignKey("ColorsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Final_Exam_Project.Shared.Product", null)
                        .WithMany()
